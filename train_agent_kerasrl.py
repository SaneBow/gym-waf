...
if __name__ == '__main__':
    # agent1, model1, history_train1, history_test1 = train_dqn_model([1024, 256], rounds=500, use_score=False)  # black blox
    ...
    agent2, model2, history_train2, history_test2 = train_dqn_model([1024, 256], rounds=50000, use_score=True)  # allow agent to see scores
